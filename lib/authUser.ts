...
// ฟังก์ชันสำหรับดึงอีเมลของผู้ใช้ที่เข้าสู่ระบบจากคุกกี้ เพื่อใช้ในการตรวจสอบสถานะการเข้าสู่ระบบและการรีเฟรชโทเค็นเมื่อจำเป็น
export function getLoggedInUserEmail(): string | null {
  return parseCookieValue(USER_EMAIL_COOKIE_KEY)
}
// ฟังก์ชันสำหรับจัดการโทเค็นรีเฟรชและอีเมลของผู้ใช้ที่เข้าสู่ระบบ เพื่อใช้ในการตรวจสอบสถานะการเข้าสู่ระบบและการรีเฟรชโทเค็นเมื่อจำเป็น
