      ...
      <Table className="border border-slate-200 bg-white">
        <TableHeader>
          <TableRow className="bg-slate-700 hover:bg-slate-700">
            ...
            <TableHead className="w-72 px-4 py-3 text-center text-xs font-semibold text-white">
              บัญชีผู้ใช้
            </TableHead>
        ...
        <TableBody>
          {paginatedRows.map((row) => (
            <TableRow key={row.id} className="even:bg-slate-50/60">
              ...
              <TableCell className="w-72 truncate px-4 py-3 text-left text-sm font-medium text-slate-800">
                {row.name}
              </TableCell>
